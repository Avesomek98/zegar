...
// Ikony SVG (outline, currentColor) zamiast emoji - patrz komentarz przy .icon-btn--svg w CSS.
const SUN_ICON_SVG = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></svg>';
const MOON_ICON_SVG = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79Z"/></svg>';

function updateThemeToggleButton() {
    const theme = effectiveTheme();
    const label = theme === "dark" ? "Włącz jasny motyw" : "Włącz ciemny motyw";
    const icon = theme === "dark" ? SUN_ICON_SVG : MOON_ICON_SVG;

    themeToggleBtn.innerHTML = icon;
    themeToggleBtn.setAttribute("aria-label", label);
    authThemeToggleBtn.innerHTML = icon;
